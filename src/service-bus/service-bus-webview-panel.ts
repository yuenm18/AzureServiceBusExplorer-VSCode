...
class WebviewState {
    ...
    stateId: number; // unique autogenerated state id
    messages: Message[];
    messagesLastUpdated: Date | undefined;
    deadLetterMessages: Message[];
    deadLetterMessagesLastUpdated: Date | undefined;
    uiState: { [key: string]: string };
    isActive: boolean; // indicates whether or not this state is currently visible
...
export class ServiceBusWebviewPanel {
    ...
    updateMessages(type: ServiceBusEntityType, entity: ServiceBusEntity, messages: Message[]) {
        ...
        if (state) {
            ...
            state.messagesLastUpdated = new Date();
    ...
    updateDeadLetterMessages(type: ServiceBusEntityType, entity: ServiceBusEntity, deadLetterMessages: Message[]) {
        ...
        if (state) {
            ...
            state.deadLetterMessagesLastUpdated = new Date();
            this.refreshWebview(type, entity);
        }
    }
